...
if __name__ == '__main__':
    ...
    y_pred = clf.predict(X['test.py'])
    prediction_type = 'logits' if dataset.is_binclass else None
    final_test_score = dataset.calculate_metrics({'test.py': y_pred}, prediction_type)['test.py'][metric] # wrong AUC for binary classification
